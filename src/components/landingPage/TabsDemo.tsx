...
export function TabsDemo() {
    const tabs = [
        ...
        //     value: "content",
        //     content: (
        //         <div className="w-[75%] overflow-hidden relative h-[50%] rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-purple-700 to-violet-900">
        //             <p>Content tab</p>
        //             <DummyContent />
        //         </div>
        //     ),
